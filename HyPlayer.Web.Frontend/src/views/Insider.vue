    ...
    <el-row justify="center">
        <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
            <el-card class="box-card">
                ...
                <el-input class="hy-form-item" v-model="userData.contact" type="email" placeholder="请输入联系邮箱"
                    clearable />
                ...
                <el-switch v-model="userData.subscribe" class="mb-2" active-text="接受邮箱更新通知" />
